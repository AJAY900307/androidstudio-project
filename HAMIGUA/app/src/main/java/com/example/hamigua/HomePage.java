...
public class HomePage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private float toppointheight=500,bottompointheight=800;//韶翔舊手機設定//上衣定位點高度，1080p解析度，新哈哥
    ...
    protected void put_Clothes_On_HAGE(String category) {
        ...
        if(category.equals("長褲") || category.equals("裙子")) {
            ...
            //韶翔舊手機長褲縮小倍率
            bottom_ScaleImage.setScaleY(0.82f); //長褲
            bottom_ScaleImage.setScaleX(0.82f); //長褲
            ...
            //韶翔舊手機短褲縮小倍率
            bottom_ScaleImage.setScaleY(0.59f);  //短褲
            bottom_ScaleImage.setScaleX(0.59f); //短褲
            bottom_ScaleImage.setTranslationY(bottompointheight-30);//移動短褲位置
